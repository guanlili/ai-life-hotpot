          ...
          {photo ? (
            ...
            >
              ...
              <button
                ...
                style={{
                  ...btn,
                  padding: isPortrait ? "10px 30px" : "14px 50px",
        ...
        {!captured ? (
          ...
          >
              ...
              {features.map((f) => (
                <div
                  ...
                  style={{
                    ...
                    letterSpacing: ".05em",
                    animation: reading
                      ? "lhPulse 1.4s ease-in-out infinite"
                      : "lhFade .5s ease both",
            ...
            <div style={{ display: "flex", gap: 16, justifyContent: "center" }}>
              ...
              <button
                onClick={next}
                style={isPortrait ? { ...btn, padding: "10px 30px", fontSize: 16 } : btn}
              >
                下一步 →
              </button>
            </div>
